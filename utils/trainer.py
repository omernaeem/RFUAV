...
from utils.DetModels.yolo.torch_utils import (select_device, torch_distributed_zero_first,
                                              smart_optimizer, de_parallel, EarlyStopping)
...
import utils.DetModels.yolo.metrics as fitness
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default=, help='models/yolov5n.yaml')
...
def main(opt, callback = Callbacks()):
    ...
    # Train
    if not opt.evolve:
        DetTrainer.train(opt.hyp, opt, device, callback)
